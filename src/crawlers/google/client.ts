...
import { Crawler, SearchOptions, SearchResult, SearchResultItem } from '../index';

export class GoogleCrawler implements Crawler {
  ...
  constructor() {
    ...
    this.apiKey = 'AIzaSyDOTyLGHSqC4-T17BLK2O1yNeoEHvpS5F4';
    this.searchEngineId = 'b5e55e9592a8e4810';
